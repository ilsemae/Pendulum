function conservationCheck_branching(q0,t,q,p) 
    ...
    theta0    =  q0(1:3);
    thetadot0 =  q0(4:6);
    h0        =  [l(1)/2*(1-cos(theta0(1)))  ,    l(1)*(1-cos(theta0(1)))+l(2)/2*(1-cos(theta0(2))) ,    l(1)*(1-cos(theta0(1)))+l(3)/2*(1-cos(theta0(3))) ];
    v01       =  l(1)/2*thetadot0(1)* [cos(theta0(1)) , -sin(theta0(1))];
    v02       =  2*v01 + l(2)/2*thetadot0(2)* [cos(theta0(2)) , -sin(theta0(2))];
    v03       =  2*v01 + l(3)/2*thetadot0(3)* [cos(theta0(3)) , -sin(theta0(3))];

    theta     =  q(:,1:3);
    thetadot  =  q(:,4:6);
    h         =  [l(1)/2*(1-cos(theta(:,1)))   ,   l(1)*(1-cos(theta(:,1)))+l(2)/2*(1-cos(theta(:,2))) , l(1)*(1-cos(theta(:,1)))+l(3)/2*(1-cos(theta(:,3)))  ,   ];
    ...
    for j=1:size(q,1)
        ...
        v3(j,:)   =  2*v1(j,:) + l(3)/2*thetadot(j,3)* [cos(theta(j,3)) , -sin(theta(j,3))];
    end
